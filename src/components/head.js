    ...
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      ...
      <div className="col-span-10 px-10">
        <div>
          ...
          />
          <button className="border border-gray-400 py-2 px-5 rounded-r-full font-semibold bg-gray-100">
            Search
          </button>
        </div>
        {showSuggestions && (
          <div className="absolute bg-white w-[33rem] py-2 px-2 rounded-lg shadow-lg border border-gray-100 ">
            <ul>
              {suggestions.map((s) => (
                <li
                  key={s}
